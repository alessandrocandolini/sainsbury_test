...
public class NetworkRequestEngine {
	 ...
	 */
	public static WebPagePojo retrieveWebPage(WebPageRequestPojo networkRequest) throws NetworkException {

		WebPagePojo htmlWebPage = null;
